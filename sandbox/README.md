...
```powershell
docker build -t hf-ai-code-sandbox:latest sandbox
```
...
Le code de pilotage de cette image est dans [dockerSandbox.js](/c:/Serveurs/hf-ai-code/lib/dockerSandbox.js).
