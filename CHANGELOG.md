...
- Added `hfaicode.agent.preferWebForFreshInfo` with a default of `true`.
...
- Documented the full April 4, 2026 worklog in [docs/WORKLOG_2026-04-04.md](/c:/Serveurs/hf-ai-code/docs/WORKLOG_2026-04-04.md).
...
- Remaining metadata step:
  ...
  - bugs/issues URL for `hf-ai-code`
